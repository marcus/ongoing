...
| Daily 04:00 scan, deterministic tool PATH, shared storage, distinct labels, and no load loop     | Scan plist, release preflight, stripped-environment `tests/release.test.ts`, `plutil -lint`                                 |
